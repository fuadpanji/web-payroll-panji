...
<body>
    <!-- BEGIN: Content-->
    <?php $i = 0; foreach ($payrolls as $payroll) { ?>
        <div class="salary-slip">
            <table class="empDetail">
                ...
                <tr>
                    <th>ID Karyawan</th>
                    <td>&emsp;:&emsp;<?= $payroll['employee_id'] ?></td>
                </tr>
                <tr>
                    <th>Nama</th>
                    <td>&emsp;:&emsp;<?= $payroll['name'] ?></td>
                </tr>
                <tr>
                    <th>Status Pegawai</th>
                    <td>&emsp;:&emsp;<?= $payroll['status'] ?></td>
                </tr>
                <tr>
                    <th>Jabatan</th>
                    <td>&emsp;:&emsp;<?= $payroll['job_designation'] ?></td>
                </tr>
                <tr>
                    <th>Tanggal Masuk</th>
                    <td>&emsp;:&emsp;<?= dateIndo($payroll['date_of_join']) ?></td>
                </tr>
                ...
                <tr class="myBackground">
                    ...
                    <td class="myAlign">
                        <?= number_format($payroll['basic_salary'] + $payroll['allowance'] + $payroll['incentive'] + $payroll['overtime_pay'], 0, ",", ".") ?>
                    </td>
                    <th colspan="3">
                        Total Potongan
                    </th>
